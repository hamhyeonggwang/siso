...
export const metadata: Metadata = { title: "시소사람들" };
      ...
      <div className="border-b border-[#E2E8F0]/80 bg-white">
        <div className="mx-auto max-w-6xl px-4 py-10 md:px-6 lg:px-8">
          <nav className="mb-4 flex items-center gap-1.5 text-[12px] text-[var(--siso-muted)]" aria-label="breadcrumb">
            ...
            <span>시소소개</span>
            <span aria-hidden>›</span>
            <span className="font-semibold text-[var(--siso-text)]">시소사람들</span>
          </nav>
          <h1 className="text-3xl font-black tracking-tight text-[var(--siso-text)]">시소사람들</h1>
